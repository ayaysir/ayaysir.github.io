...
Xcode에서 매 빌드마다 `.podspec` 파일의 **패치 버전**(Patch)을 자동으로 +1 해주는 **Run Script**를 작성할 수 있습니다. 프로젝트 루트에 위치한 `[프로젝트명].podspec` 파일을 찾아 현재 버전을 읽고, 패치 버전을 증가시킨 뒤 다시 파일을 수정합니다.
...
![Pods 클릭](/assets/img/wp-content/uploads/2025/04/screenshot-2025-04-24-pm-8.11.11-copy.jpg)  
*Pods 클릭*

![Run Script 추가](/assets/img/wp-content/uploads/2025/04/screenshot-2025-04-24-pm-8.18.22-copy.jpg) 
*상단의 `[+]` 버튼을 눌러 `Run Script` 추가*

#### **Step 2: 호환성을 위해 Shell을 / b i n / b a s h로 설정**

![Shell 변경](/assets/img/wp-content/uploads/2025/04/screenshot-2025-04-24-pm-8.00.59-copy.jpg)
*Shell 변경*
...
단, 한 번 릴리즈된 버전은 CocoaPods 서버에 재등록할 수 없기 때문에, **실제 배포 전에 반드시 커밋 + 태그 작업도 병행**해야 합니다.
