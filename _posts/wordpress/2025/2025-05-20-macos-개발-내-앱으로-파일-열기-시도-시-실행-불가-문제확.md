...
macOS에서 포스트잇 플레인 텍스트 앱인 [StickyPlainPad](/macos-앱-포트폴리오-플레인-텍스트를-작성-관리할-수-있/)을 테스트하는 중, 특정 테스트 파일 "다음으로 열기..."를 통해 실행했을 때 다음과 같은 문제가 발생하였습니다.
...
> **노터라이즈(Notarize)란?**<br>Apple이 앱을 자동으로 검사하여 악성 코드가 없는지 확인한 후 서명된 티켓(ticket)을 부여하는 절차입니다. App Store 외부에서 배포되는 앱에도 이 검증을 적용함으로써 사용자 보안을 강화합니다.
...
![](/assets/img/wp-content/uploads/2025/05/screenshot-2025-05-20-pm-7.00.48-copy.jpg)
