...
{% gist "041784bd269ddb37b48a01dde5dc5e6c" %}
 

## 동작 화면

 ![](/assets/img/wp-content/uploads/2021/08/screenshot-2021-08-28-pm-9.03.14.jpg)
...
- [자바스크립트: 콘솔 로그(console.log) 사용법, 로그에 CSS 적용, 로그 그룹화 하기](/posts/자바스크립트-콘솔-로그에-css-적용-그룹화-하기/)
