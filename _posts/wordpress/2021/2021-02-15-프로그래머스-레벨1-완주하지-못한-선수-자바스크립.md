...
![예제 #2 에서 객체 변수, `vinko`만 완주하지 못했으므로 값으로 1을 가집니다.](/assets/img/wp-content/uploads/2021/02/screenshot-2021-02-15-pm-9.12.16.png)  
*예제 #2 에서 객체 변수, `vinko`만 완주하지 못했으므로 값으로 1을 가집니다.*
