...
1) `WebKit View`를 뷰 위에 추가합니다.
 ...
 ![](/assets/img/wp-content/uploads/2021/08/screenshot-2021-08-26-오전-12.31.36.jpg)

 

2) 뷰 컨트롤러 소스 파일에 웹킷 뷰를 연결한 `@IBOutlet` 변수를 추가합니다.

 ![](/assets/img/wp-content/uploads/2021/08/screenshot-2021-08-26-오전-12.35.30.jpg)

 

3) 다음 프로젝트 폴더에서 마우스 오른쪽 버튼을 누른 뒤 `Show in Finder` 메뉴를 선택해 파인더 탐색기를 엽니다.

 ![](/assets/img/wp-content/uploads/2021/08/screenshot-2021-08-26-오전-12.37.06.jpg)

 

4) 웹페이지 파일을 담을 새로운 폴더를 생성합니다.

 ![](/assets/img/wp-content/uploads/2021/08/screenshot-2021-08-26-오전-12.37.43.jpg)

 

5) 다음 이 폴더를 프로젝트 내부로 드래그합니다.

 ![](/assets/img/wp-content/uploads/2021/08/screenshot-2021-08-26-오전-12.38.30.jpg)

 

6) 그러면 다음 창이 뜨는데 여기서 `Create folder references`를 선택합니다. 이 옵션을 선택해야 이미지 파일 등의 `static` 파일을 표시할 수 있습니다.

 ![](/assets/img/wp-content/uploads/2021/08/screenshot-2021-08-26-오전-12.39.03.jpg)

 

7) 완료하였다면 다음과 같은 파란색 폴더 모양의 폴더 레퍼런스가 생성되었습니다.

 ![](/assets/img/wp-content/uploads/2021/08/screenshot-2021-08-26-오전-12.39.30.jpg)
...
시뮬레이터를 실행하면 다음과 같이 웹 페이지가 열리게 됩니다.
 ...
 ![](/assets/img/wp-content/uploads/2021/08/screenshot-2021-08-26-오전-1.05.07.jpg)
