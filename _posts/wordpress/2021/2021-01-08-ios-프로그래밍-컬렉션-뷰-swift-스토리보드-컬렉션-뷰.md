...
먼저 `Assets.xcassets`에 사진 파일들을 저장합니다.
 ...
 ![](/assets/img/wp-content/uploads/2021/01/screenshot-2021-01-09-오전-12.29.20.png)
...
컬렉션 뷰 내의 셀의 사이즈를 조정하고, `Image` 오브젝트와 `Label` 오브젝트를 추가합니다.
 ...
 ![](/assets/img/wp-content/uploads/2021/01/screenshot-2021-01-09-오전-12.26.35.png)
...
메인 스토리보드에서 `Assistant`를 활성화한 뒤, 오브젝트와 `@IBOutlet` 을 연결합니다.
 ...
 ![](/assets/img/wp-content/uploads/2021/01/screenshot-2021-01-09-오전-12.31.11.png)
