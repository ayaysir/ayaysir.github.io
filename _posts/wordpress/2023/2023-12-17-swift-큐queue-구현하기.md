...
- **enqueue(\_:)**
    - `head`가 비어있다면(`nil`) `head`, `tail`에 새로 입력한 값 노드를 대입합니다.  ![](/assets/img/wp-content/uploads/2023/12/screenshot-2023-12-18-오전-2.03.48-copy.jpg)
    - `head`가 이미 존재한다면 기존 `tail`의 `next`에 새 값 노드를 지정하고, 이 새 값 노드를 새로운 `tail`로 지정합니다.  ![](/assets/img/wp-content/uploads/2023/12/screenshot-2023-12-18-오전-2.08.52-copy.jpg)
- **dequeue()**
...
####  ![](/assets/img/wp-content/uploads/2023/12/screenshot-2023-12-18-오전-2.26.20-copy.jpg)
