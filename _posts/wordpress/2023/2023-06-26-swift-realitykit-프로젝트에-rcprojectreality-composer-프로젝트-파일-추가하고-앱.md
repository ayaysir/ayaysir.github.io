...
- `Content Technology`를 `RealityKit`으로 설정
 ...
 ![](/assets/img/wp-content/uploads/2023/06/screenshot-2023-06-26-pm-9.38.34-copy.jpg)

 ![](/assets/img/wp-content/uploads/2023/06/screenshot-2023-06-26-pm-9.38.50-copy.jpg)
...
아이폰의 [Reality Composer 앱](https://apps.apple.com/us/app/reality-composer/id1462358802)에서 작업한 프로젝트 파일을 에어드랍 등을 이용해서 Xcode가 있는 PC로 옮깁니다. 확장자는 `.rcproject`입니다.
 ...
 ![](/assets/img/wp-content/uploads/2023/06/IMG_B802B6D77D26-1-copy.jpeg)

 

파일을 프로젝트 내부로 드래그 앤 드롭합니다.

 ![](/assets/img/wp-content/uploads/2023/06/screenshot-2023-06-26-pm-9.26.01-copy.jpg)
...
- `체크하지 않으면` 파일이 복사되지 않고 원본 폴더에 그대로 위치하며 변동 사항이 그대로 적용됩니다. 프로젝트에서 삭제할 때 휴지통에 버리기 옵션을 선택한 경우 원본 파일이 휴지통으로 이동합니다.
 ...
 ![](/assets/img/wp-content/uploads/2023/06/screenshot-2023-06-26-pm-9.26.50-copy.jpg)
...
예를 들어 `Drum.rcproject` 파일을 추가했다면 해당 파일을 바탕으로 자동으로 `enum` 클래스가 생성되며 Swift 코드 내부에서 실행할 수 있습니다.
 ...
 ![](/assets/img/wp-content/uploads/2023/06/screenshot-2023-06-26-pm-9.56.24.png)
...
다시 빌드가 완료된 경우 다음처럼 자동 추천에 `load장면()` 함수가 뜹니다.
 ...
 ![](/assets/img/wp-content/uploads/2023/06/screenshot-2023-06-26-pm-9.30.47-copy.jpg)
...
> 
>  ![](/assets/img/wp-content/uploads/2023/06/screenshot-2023-06-26-pm-9.33.41-copy.jpg)
...
> 
>  ![](/assets/img/wp-content/uploads/2023/06/screenshot-2023-06-26-pm-9.28.05-copy.jpg)
> 
> 2\. 빨간 배지가 뜬 `정보` 버튼을 누른 뒤 컴퓨터에 없는 자료들을 모두 다운로드 한 뒤 다시 실행합니다.
> 
>  ![](/assets/img/wp-content/uploads/2023/06/screenshot-2023-06-26-pm-9.01.13-copy.jpg)
