...
{% youtube "https://www.youtube.com/watch?v=xGmXxpIj6vs" %}
...
유튜브를 보다 보니 이 게임을 만드는 영상이 있어서 따라해 보았습니다. 영상의 내용을 정리해 시리즈로 나눠 스네이크 게임을 만들어보는 글을 연재해보도록 하겠습니다.
...
이 코드는 반드시 `game` 함수 안에 삽입되어야 합니다. 바깥에 삽입하면 처음 한 번만 그리기 작업을 수행하는데, `game` 함수가 렌더링 될 때 아래와 같이 지워지지 않는 자국을 남깁니다.
 ...
 ![](/assets/img/wp-content/uploads/2020/11/screenshot-2020-11-15-pm-5.31.32.png)
...
![](https://media0.giphy.com/media/v1.Y2lkPTc5MGI3NjExNjRtbmlvOGNuZDA1dzN3bXVnamk3dzZmN2FueWtyNjlqbjZveXFmeSZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/GTwtWEj7zjp12ybt6q/giphy.gif)
...
![](https://media2.giphy.com/media/v1.Y2lkPTc5MGI3NjExcXczMGZncGU1bG12YXp3aHNjdDZhNzBvYnJ0dnk1c2ZsMWZyZnJkZyZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/2dhjTGnG30Rq0DBVMv/giphy.gif)
 
