...
- File > New > Project > iOS > Single App View
 ...
 ![](/assets/img/wp-content/uploads/2020/02/screenshot-2020-02-08-pm-9.07.15.png)
...
스토리보드는 주로 **Main.storyboard**에서 진행됩니다.
 ...
 ![](/assets/img/wp-content/uploads/2020/02/-2020-02-08-pm-9.49.50-e1581169157294.png)
...
## **메인 스토리보드에 요소 추가**
 ...
 ![](/assets/img/wp-content/uploads/2020/02/screenshot-2020-02-08-pm-10.41.00.png)

Xcode의 오른쪽 상단을 보면 + 버튼이 있습니다. 이것을 클릭하면 아래 화면이 나옵니다. `Label`과 `Button`, `Image View`를 스토리보드에 드래그해 요소들을 추가합니다.

 ![](/assets/img/wp-content/uploads/2020/02/screenshot-2020-02-08-pm-9.50.15.png)

요소들을 추가한 후 내용과 서식을 추가 및 수정하고 위치를 적당히 옮긴 사진입니다.

 ![](/assets/img/wp-content/uploads/2020/02/screenshot-2020-02-08-pm-10.33.14.png)
...
![](/assets/img/wp-content/uploads/2020/02/screenshot-2020-02-08-pm-10.45.00.png)

![어시스턴트 코드 창이 나온 모습](/assets/img/wp-content/uploads/2020/02/screenshot-2020-02-08-pm-10.46.25.png)  
*어시스턴트 코드 창이 나온 모습*
...
그 다음에 요소를 클릭한 뒤 마우스 오른쪽 버튼을 누르고 코드창으로 드래그합니다. 반드시 **마우스 오른쪽 버튼**이어야 합니다. 드래그하면 파란색의 선이 나타납니다.
 ...
 ![](/assets/img/wp-content/uploads/2020/02/screenshot-2020-02-08-pm-10.00.05.png)

드래그하면 정보 입력 창이 나타납니다. 아웃렛 변수로 사용할 이름을 입력합니다. 나머지는 따로 건드리지 않고 **Connect** 버튼을 누르면 연결이 됩니다.

 

 ![](/assets/img/wp-content/uploads/2020/02/screenshot-2020-02-08-pm-10.51.45.png)
...
연결되는 원리는 스토리보드의 XML을 보면 알 수 있습니다. 이 XML은 사용자가 작성하는 것이 아니고 Xcode가 작성해 주는 것이므로 참고만 하면 됩니다.
 ...
 ![](/assets/img/wp-content/uploads/2020/02/screenshot-2020-02-08-pm-10.53.55.png)
...
![](https://media2.giphy.com/media/v1.Y2lkPTc5MGI3NjExdnI5dXVnN2wzMG42eXo1OHoyc3NqcjZnaGtxN2VwdTd3NXI3azIxMiZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/MFsxry8a0ERp3lwcT6/giphy.gif)