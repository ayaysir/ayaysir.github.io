...
- [스프링 부트 (Spring Boot): mp3을 전송하는 컨트롤러 &#8211; 크롬 및 사파리(Safari) 브라우저에서 구간 탐색이 안되는 문제 해결 방법](/posts/스프링-부트-spring-boot-mp3을-전송하는-컨트롤러-크롬-및-사파/)
...
아이폰에서도 정상 재생되며 백그라운드에서도 정상 동작 합니다. 
