...
- `user_id` - 터미널에 접속하면 보이는 빨간색 부분 (또는 루트 디렉토리에서 `pwd`를 누르면 `home/` 뒤에 나오는 정보)이 유저 아이디입니다.  
![](/assets/img/wp-content/uploads/2020/07/screenshot-2020-07-29-pm-4.47.40.png)
- `ec2_public_ip` - 퍼블릭 DNS나 퍼블릭 IP(v4) 중 하나를 사용합니다.  
![](/assets/img/wp-content/uploads/2020/07/-2020-07-29-pm-4.28.44-e1596009393987.png)
