...
- [SwiftUI: Xcode 15 버전 이상에서 iOS 하위 버전 (15.0 이상) 호환되는 위젯 생성](/posts/swiftui-xcode-15-버전-이상에서-ios-하위-버전-15-0-이상-호환되는-위젯/)
...
{% youtube "https://youtube.com/shorts/A-xzyw8zeu8?feature=share" %}
 
...
1. iOS 15.0 이상에서 호환되도록 설정하기 ([참고](/posts/swiftui-xcode-15-버전-이상에서-ios-하위-버전-15-0-이상-호환되는-위젯/))
