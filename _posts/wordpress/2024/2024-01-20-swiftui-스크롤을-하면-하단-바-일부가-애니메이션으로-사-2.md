...
- [SwiftUI: 스크롤을 하면 하단 바 일부가 애니메이션으로 사라지거나 나타나기 (사파리처럼) 上](/posts/swiftui-스크롤을-하면-하단-바-일부가-애니메이션으로-사/)
...
![](https://media1.giphy.com/media/v1.Y2lkPTc5MGI3NjExNW1hY3g5YWEyMDZ0dmdoeDdobTFhZzVrajl6MHN3N2dyanZxMDU0diZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/TBwPdSqknf4AZLxquv/giphy.gif)

[이전 예제](_posts/swiftui-스크롤을-하면-하단-바-일부가-애니메이션으로-사)에서 해당 동작을 @State로 구현하는 방법을 설명하였습니다. 이번 포스트는 실제로 웹뷰의 스크롤 상태에 따라 하단 툴바가 확장/축소되기 위한 과정을 진행합니다.
...
- **webViewHandler**
    ...
    - SwiftUI의 뷰에서 Representable로 데이터를 [보내는 과정](/posts/swiftui-swiftui의-view에서-uirepresentableviewviewcontroller에-접근하여-명령을-실행하는/)은 [복잡](/posts/swiftui-웹-뷰wkwebview-추가하기-및-자바스크립트-실행-representable-사용/)하지만, Representable로부터 데이터를 받는 것은 위와 같이 클로저 함수만으로도 가능하므로 상대적으로 덜 복잡합니다.
- **webView.scrollView.delegate = context.coordinator**
...
- 이전 포스트의 메인 뷰의 `body` 내에 웹뷰를 추가합니다.
 ...
 ![](/assets/img/wp-content/uploads/2024/01/Simulator-Screenshot-iPhone-15-Pro-2024-01-20-at-20.46.46-copy.jpg)
...
<!-- http://www.giphy.com/gifs/TBwPdSqknf4AZLxquv -->
![](https://media1.giphy.com/media/v1.Y2lkPTc5MGI3NjExMXVrOXQydGhrbzM3bGx2a2o4bXB6ZWFzNmszajU2ZTIxeTZoOGtvbiZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/TBwPdSqknf4AZLxquv/giphy.gif)  
_스크롤 동작 시_

 

<!-- http://www.giphy.com/gifs/maqEBaFkgyvv7BbUuK -->
![](https://media1.giphy.com/media/v1.Y2lkPTc5MGI3NjExNDd5bXUzN2p2NWJhNGt2Mm9leHlhZGRmazlkdjZzd2hiZXhydXdwdSZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/maqEBaFkgyvv7BbUuK/giphy.gif)  
_확대/축소 동작 시_
