...
![](/assets/img/wp-content/uploads/2024/08/screenshot-2024-08-29-pm-4.28.15.jpg)

![](/assets/img/wp-content/uploads/2024/08/screenshot-2024-08-29-pm-4.28.28.jpg)

![](/assets/img/wp-content/uploads/2024/08/screenshot-2024-08-29-pm-4.28.34.jpg)
...
1. **입력 처리**  
`n`은 이미지의 크기이며, 이미지 데이터는 `a`라는 2차원 배열에 저장됩니다.`readLine()`을 통해 입력을 받아 `a` 배열에 저장된 후, 각 요소는 문자열로 변환됩니다.
...
## **실행 예제**
 ...
 ![](/assets/img/wp-content/uploads/2024/08/screenshot-2024-08-29-pm-6.29.25.jpg)
