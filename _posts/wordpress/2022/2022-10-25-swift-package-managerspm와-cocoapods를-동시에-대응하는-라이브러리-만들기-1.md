...
'패키지를 생성하면 기본 파일 구조는 아래와 같습니다.
 ...
 ![](/assets/img/wp-content/uploads/2022/10/screenshot-2022-10-26-am-2.05.37.jpg)
...
입력하면 아래와 같은 폴더가 생성됩니다.
 ...
 ![](/assets/img/wp-content/uploads/2022/10/screenshot-2022-10-25-am-1.25.31.jpg)
...
완료 후 `.xcworkspace` 파일을 열면 아래와 같은 작업 환경이 나타납니다.
 ...
 ![](/assets/img/wp-content/uploads/2022/10/screenshot-2022-10-26-am-2.29.01.jpg)
...
원격 레퍼지토리에 접속한 뒤 태그 및 릴리즈를 생성합니다. 아래 빨간색 박스 부분을 클릭합니다.
 ...
 ![](/assets/img/wp-content/uploads/2022/10/screenshot-2022-10-25-am-1.54.35.jpg)

`[Create a new release]` 초록색 버튼을 누릅니다.

 ![](/assets/img/wp-content/uploads/2022/10/screenshot-2022-10-25-am-1.55.05.jpg)

왼쪽 상단에 태그 추가 버튼이 있는데 눌러서 추가합니다. 스크린샷에는 잘못 찍혔는데 버전 앞에 v를 입력하지 않고 `1.0.0` **숫자만 입력**합니다. (v가 추가되면 CocoaPods로 배포할 수 없음)

 ![](/assets/img/wp-content/uploads/2022/10/screenshot-2022-10-25-am-1.56.16.jpg)
...
새로운 태그 및 릴리즈가 추가되면 아래 화면과 같이 목록에 나옵니다. 태그 버전은 CocoaPods에서 사용하므로 메모해둡니다.
 ...
 ![](/assets/img/wp-content/uploads/2022/10/screenshot-2022-10-26-am-2.40.30.png)
...
얼마 후 이메일이 도착하는데 링크를 클릭해 이메일을 인증합니다.
 ...
 ![](/assets/img/wp-content/uploads/2022/10/-2022-10-25-am-2.03.39-e1666721817945.jpg)

 

링크를 클릭하면 웹 브라우저에 아래와 같은 화면이 나옵니다.

 ![](/assets/img/wp-content/uploads/2022/10/screenshot-2022-10-25-am-2.04.32.jpg)
...
2. Swift 버전이 불명확하다.
 ...
 ![](/assets/img/wp-content/uploads/2022/10/screenshot-2022-10-25-am-2.06.13.jpg)
...
- `s.swift_version`
 ...
 ![](/assets/img/wp-content/uploads/2022/10/screenshot-2022-10-25-am-2.09.16.jpg)

문제점을 보완하고 재검사를 받아 성공하면 아래와 같이 초록색 문자로 **passed validation**.이라고 뜹니다.

 ![](/assets/img/wp-content/uploads/2022/10/screenshot-2022-10-25-am-2.11.01.jpg)  ![](/assets/img/wp-content/uploads/2022/10/screenshot-2022-10-25-am-2.12.16.jpg)
...
업로드에 성공하면 맨 아래와 같이 이모티콘과 함께 _**Congrats**_ 라는 메시지가 뜹니다.
 ...
 ![](/assets/img/wp-content/uploads/2022/10/screenshot-2022-10-25-am-2.42.48.jpg)
...
```
 ...
 ![](/assets/img/wp-content/uploads/2022/10/screenshot-2022-10-25-am-2.36.17.jpg)
...
설치가 진행되면 아래와 같이 초록색으로 글자가 나타납니다.
 ...
 ![](/assets/img/wp-content/uploads/2022/10/screenshot-2022-10-25-am-2.55.23.jpg)

```
SimpleAlert.present(message: ",,,,,", title: "Test from CocoaPods")
```

 ![](/assets/img/wp-content/uploads/2022/10/screenshot-2022-10-25-am-2.56.51.jpg)
