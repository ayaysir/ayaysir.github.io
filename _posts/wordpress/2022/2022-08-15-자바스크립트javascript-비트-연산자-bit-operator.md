...
왜 `6(110B)`이 나올까요? 70과 60을 이진법으로 변환시킨 뒤 계산해보면 이해할 수 있습니다.
 ...
 ![](/assets/img/wp-content/uploads/2022/08/screenshot-2022-08-16-오전-1.53.15.png)
...
```
 ...
 ![](/assets/img/wp-content/uploads/2022/08/screenshot-2022-08-16-오전-2.03.08.png)
...
`204`와 `2^7 = 128(1000 0000B)`를 `AND` 연산하면 맨 앞의 `1`을 제외하고는 공통되는 비트가 없으므로 나머지는 전부 `0`이 됩니다. 따라서 `204 & 128`의 연산 결과는 `128(1000 0000B)`이 됩니다.
 ...
 ![](/assets/img/wp-content/uploads/2022/08/screenshot-2022-08-16-오전-2.06.37.png)
...
AND 연산과 달리 `118(111 0110B)`이 나오는 이유는 아래 그림을 보면 알 수 있습니다.
 ...
 ![](/assets/img/wp-content/uploads/2022/08/screenshot-2022-08-16-오전-2.15.03.png)
...
`70 ^ 54 = 112 (111 0000B)`
 ...
 ![](/assets/img/wp-content/uploads/2022/08/screenshot-2022-08-16-오전-2.54.49.jpg)
...
```
 ...
 ![](/assets/img/wp-content/uploads/2022/08/screenshot-2022-08-16-오전-2.39.54.png)
...
```
 ...
 ![](/assets/img/wp-content/uploads/2022/08/screenshot-2022-08-16-오전-2.44.37.png)
