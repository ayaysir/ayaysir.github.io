...
![](/assets/img/wp-content/uploads/2022/05/screenshot-2022-05-20-pm-7.29.16.jpg)   
*이벤트 스트림의 흐름을 그림으로 나타낸것을 마블 다이어그램(Marble Diagram)이라고 합니다. 동그라미 모양이 이벤트 발생, X 표시는 에러의 발생, 세로 막대기는 이벤트 스트림의 완료를 의미합니다.*
...
![](/assets/img/wp-content/uploads/2022/05/screenshot-2022-05-20-pm-11.12.41.jpg)   
*`@IBOutlet` 연결*
...
![](/assets/img/wp-content/uploads/2022/05/99361F4A5B47841627.png)   
*참고: `combineLatest`*
...
![](https://media2.giphy.com/media/v1.Y2lkPTc5MGI3NjExYzd5ajg2MWxzdDV1enFicGgwMDNuNml5aTNrcWo3Mm9yZnQ5ZmR2aSZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/83zY8HsjQnCRdeYNPD/giphy.gif)
