...
\[caption id="attachment\_4869" align="alignnone" width="959"\] ![](/assets/img/wp-content/uploads/2022/10/mosaiced-screenshot-2022-10-02-am-12.06.50.jpg) 웹 브라우저(크롬)에서는 JSON이 표시됨\[/caption\]

 

\[caption id="attachment\_4868" align="alignnone" width="682"\] ![](/assets/img/wp-content/uploads/2022/10/mosaiced-screenshot-2022-10-02-am-12.11.29.jpg) 자바스크립트 내에서 호출하려 하면 CORS 에러 발생\[/caption\]
...
먼저 **_\[내\_주소\]/proxy/index.php_** 경로에 PHP 파일을 생성합니다. 이 PHP 파일의 주소가 새로 사용할 API 주소입니다.
 ...
 ![](/assets/img/wp-content/uploads/2022/10/mosaiced-screenshot-2022-10-02-am-12.16.50.jpg)
...
```
 ...
 ![](/assets/img/wp-content/uploads/2022/10/mosaiced-screenshot-2022-10-02-am-12.22.21.jpg)
...
>     - _예) `http://example.com` 와 `http://example.com/` => 둘은 다른 URL입니다.  ![](/assets/img/wp-content/uploads/2022/10/mosaiced-screenshot-2022-10-01-pm-9.59.05.jpg)_ 
...
\[caption id="attachment\_4872" align="alignnone" width="843"\] ![](/assets/img/wp-content/uploads/2022/10/mosaiced-screenshot-2022-10-02-am-12.46.54.jpg) 프록시 페이지로 접속한 결과\[/caption\]

 

\[caption id="attachment\_4873" align="alignnone" width="951"\] ![](/assets/img/wp-content/uploads/2022/10/mosaiced-screenshot-2022-10-02-am-12.47.27.jpg) 원래 API 출력 결과와 비교\[/caption\]
