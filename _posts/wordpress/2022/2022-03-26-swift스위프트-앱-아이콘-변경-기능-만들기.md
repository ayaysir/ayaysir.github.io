...
대표적인 예로, 현재는 불가능하지만 예전에 인스타그램에서 깜짝 이벤트로 아이콘 변경 기능을 선보였던 적이 있었는데, 오늘 구현할 예제가 이것과 동일한 원리로 동작합니다.
 ...
 ![](/assets/img/wp-content/uploads/2022/03/screenshot-2022-03-27-am-1.13.35.jpg)
...
이 예제는 기본 아이콘이 아래 그림과 같은 모양이며, 기본 아이콘 외에 `Clock`, `Note`, `Space` 3가지의 추가 아이콘을 가지고 있습니다. 변경 페이지에서 해당 아이콘을 클릭하면 홈 화면의 아이콘을 변경할 수 있습니다.
 ...
 ![](/assets/img/wp-content/uploads/2022/03/-2022-03-27-am-1.11.53-e1648311379881.jpg)

 ![](/assets/img/wp-content/uploads/2022/03/-2022-03-27-am-1.12.02-e1648311415703.jpg)
...
\[caption id="attachment\_4298" align="alignnone" width="194"\] ![](/assets/img/wp-content/uploads/2022/03/screenshot-2022-03-25-pm-7.18.12.jpg) appicon.co 사이트를 통해 사이즈별로 이미지 파일이 준비된 모습\[/caption\]
...
이런식으로 변경하고자 하는 아이콘마다 사이즈에 맞게 준비합니다.
 ...
 ![](/assets/img/wp-content/uploads/2022/03/screenshot-2022-03-27-am-1.26.44.jpg)
...
이렇게 각 사이즈의 아이콘 이미지를 준비했다면, Finder(탐색기)에서 파일을 프로젝트로 드래그하여 Xcode 프로젝트에 아이콘 파일을 추가합니다. 참고로 Assets 내에 추가하지 말고 프로젝트 내에 추가해야 하며, 폴더 생성시 `Create Group`을 선택합니다.
 ...
 ![](/assets/img/wp-content/uploads/2022/03/screenshot-2022-03-25-pm-7.27.58.jpg)

 ![](/assets/img/wp-content/uploads/2022/03/screenshot-2022-03-27-am-1.24.15.jpg)
...
- [iOS 프로그래밍: 컬렉션 뷰 (Swift, 스토리보드) – 컬렉션 뷰 추가, 커스텀 셀 작성](http://yoonbumtae.com/?p=3418)
 ...
 ![](/assets/img/wp-content/uploads/2022/03/screenshot-2022-03-27-am-1.28.29.jpg)
...
먼저 프로젝트의 `info.plist`를 마우스 오른쪽 클릭한 뒤, `Open As > Source Code`로 열면 XML 코드가 있는 에디터가 실행됩니다.
 ...
 ![](/assets/img/wp-content/uploads/2022/03/screenshot-2022-03-25-pm-8.36.01.jpg)
...
다음 파일의 맨 끝부분을 찾습니다. `</dict></plist>` 이 부분의 바로 윗부분이 새로운 코드를 추가할 부분입니다.
 ...
 ![](/assets/img/wp-content/uploads/2022/03/screenshot-2022-03-25-pm-8.37.16.jpg)
...
 
 ...
 ![](/assets/img/wp-content/uploads/2022/03/screenshot-2022-03-25-pm-8.40.03.jpg)
...
Property LIst 에디터로 다시 열면 대략 다음과 같은 형태가 됩니다.
 ...
 ![](/assets/img/wp-content/uploads/2022/03/screenshot-2022-03-25-pm-8.47.46.jpg)
...
\[caption id="attachment\_4309" align="alignnone" width="401"\] ![](/assets/img/wp-content/uploads/2022/03/screenshot-2022-03-27-am-1.44.08.jpg) 소스 코드\[/caption\]

\[caption id="attachment\_4310" align="alignnone" width="176"\] ![](/assets/img/wp-content/uploads/2022/03/screenshot-2022-03-27-am-1.45.01.jpg) 프로퍼티 리스트 에디터\[/caption\]
...
아이콘 변경 내용이 반영되지 않는다면 아래와 같이 시뮬레이터 또는 기기를 재부팅합니다.
 ...
 ![](/assets/img/wp-content/uploads/2022/03/screenshot-2022-03-27-am-1.48.34.jpg)
