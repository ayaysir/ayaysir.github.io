...
![`firstrun` 클로저는 앱 설치 후 최초 실행시에만 실행되고, 그 이후에는 실행되지 않습니다.](/assets/img/wp-content/uploads/2022/05/screenshot-2022-05-21-pm-11.49.58.jpg)  
*`firstrun` 클로저는 앱 설치 후 최초 실행시에만 실행되고, 그 이후에는 실행되지 않습니다.*

<br>

이 상태에서 다시 빌드하고 실행하면 `nothingChanged`가 실행됩니다.

![`nothingChanged` 클로저는 버전이 변하지 않았을 때 실행됩니다.](/assets/img/wp-content/uploads/2022/05/screenshot-2022-05-21-pm-11.50.22.jpg)  
*`nothingChanged` 클로저는 버전이 변하지 않았을 때 실행됩니다.*

<br>

프로젝트 설정에서 버전을 변경합니다.

![버전 변경 후 다시 실행](/assets/img/wp-content/uploads/2022/05/screenshot-2022-05-21-pm-11.51.24.jpg)  
*버전 변경 후 다시 실행*
...
![`updated` 클로저는 앱 버전이 변경될 때마다 실행됩니다. (버전 업/다운 모두 포함)](/assets/img/wp-content/uploads/2022/05/-2022-05-21-pm-11.52.12-e1653145801769.jpg)  
*`updated` 클로저는 앱 버전이 변경될 때마다 실행됩니다. (버전 업/다운 모두 포함)*
