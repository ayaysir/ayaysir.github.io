...
iTunes (또는 Finder)는 iPhone이 복구 모드에서 발견되었다는 경고를 표시합니다.
 ...
 ![](/assets/img/wp-content/uploads/2019/11/iphone-xr-xs-x-xs-max-recovery-mode.jpg) 
 
 복구 모드로 들어가면 iPhone XR, XS, XS Max, X를 사용 가능한 최신 iOS 버전으로 업데이트 하거나 백업 또는 장치를 다음과 같이 설정하여 평소대로 iTunes (또는 Finder)로 복원 할 수 있습니다.
