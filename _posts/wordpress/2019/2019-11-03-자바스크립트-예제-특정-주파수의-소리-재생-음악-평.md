...
자바에서 주파수를 재생하는 글 [자바 예제: 특정 주파수의 소리 재생](/posts/자바-예제-특정-주파수의-소리-재생/) 을 자바스크립트로 바꾼 예제입니다. 외부 온라인 소스나 라이브러리 필요 없이 자바스크립트 자체 엔진으로 소리를 재생합니다.
...
{% gist "85e974b311fad4f777e00dc65bb1d8d6" %}

<!-- - [예제 사이트 바로가기](http://y1oonbumtae.com/music/freq-table.html) -->
...
{% youtube "https://youtu.be/I385i4ZXhOg" %}
