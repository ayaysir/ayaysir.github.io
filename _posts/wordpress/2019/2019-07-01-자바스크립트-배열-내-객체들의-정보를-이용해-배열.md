...
이 객체 배열들을 정렬하는 방법은 
1. **for문을 직접 돌려서 하는 방법**과, 
2. **자바스크립트에서 제공하는 `Array.sort()` 기능을 사용**하는 방법이 있습니다.

후자에 대해 설명하겠습니다. ([참고 사이트](https://developer.mozilla.org/ko/docs/Web/JavaScript/Reference/Global_Objects/Array/sort))
