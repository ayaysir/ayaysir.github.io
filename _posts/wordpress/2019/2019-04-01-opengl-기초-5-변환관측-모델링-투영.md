...
![](/assets/img/wp-content/uploads/2019/04/gv1-e1579004275970.png)  
*ex=0.3, ey=0.0, ez=0.0*


마찬가지로 k키를 눌러 y 축을 따라 위쪽으로 관측 지점을 옮기면 물체는 아래쪽으로 이동한다.

![](/assets/img/wp-content/uploads/2019/04/gv2-e1579004313321.png)  
...
![](/assets/img/wp-content/uploads/2019/04/gv3-e1579004368994.png)  
...
![](/assets/img/wp-content/uploads/2019/04/image006-2-e1579004428576.jpg)  
*(1) 주전자 1개 그리기* 


오른쪽으로 0.6만큼 이동시킨 후 똑같은 주전자를 하나 더 그렸다. 조금 이동한 위치에 그려질 것이다. 

![](/assets/img/wp-content/uploads/2019/04/image008-1-e1579004501215.jpg)  
*(2) 오른쪽으로 0.6 이동 후 주전자 1개 그리기*

이번에는 오른쪽뿐만 아니라 가운데 주전자의 위쪽에도 하나를 더 그려 보자. y 축으로 0.5만큼 이동한 곳에 하나 더 그리면 될 것 같다

![](/assets/img/wp-content/uploads/2019/04/image010-1-e1579004573987.jpg) 
...
  ![](/assets/img/wp-content/uploads/2019/04/screenshot-2020-01-14-pm-9.28.47.png)
...
![](/assets/img/wp-content/uploads/2019/04/screenshot-2020-01-14-pm-9.29.42.png)  
*다르게 나온 그림*
...
![](/assets/img/wp-content/uploads/2019/04/screenshot-2020-01-14-pm-9.30.35.png)  
*원래 기대했던 그림*
...
![](/assets/img/wp-content/uploads/2019/04/gp1-e1579005959902.png)  
...
![](/assets/img/wp-content/uploads/2019/04/gp7-e1579006064656.png)  
...
![](/assets/img/wp-content/uploads/2019/04/gp2-e1579006137833.png)  
*(0, 0, 0)(-1.0, 1.0, -1.0, 1.0, -0.6, 0.6)*

![](/assets/img/wp-content/uploads/2019/04/gp3-e1579006163380.png)  
...
![](/assets/img/wp-content/uploads/2019/04/gp4-e1579006285621.png)  
*(0, 0, 0)(-1.0, 1.0, -1.0, 1.0, -0.8, -0.2)*

![](/assets/img/wp-content/uploads/2019/04/gp6-e1579006312796.png)  
...
한편, **직교 투영**은 평행하게 투영하므로 공간상의 크기가 같으면 거리에 상관없이 **동일한 크기**로 보인다. 피라미드를 (30, -120) 각도로 회전하여 밑면이 보이도록 해 보자.
 ...
 ![](/assets/img/wp-content/uploads/2019/04/screenshot-2020-01-14-pm-9.52.11.png)
...
팝업 메뉴에서 Frustum이나 Perspective를 선택하면 원근 투영으로 바뀌며 Near는 1, far는 10으로 정의된다. 원근 투영을 하면 원점에 있는 물체가 너무 가까와 가시 영역에 들어오지 못하므로 z축으로 -2만큼 더 뒤쪽으로 이동시켰다.
 ...
 ![](/assets/img/wp-content/uploads/2019/04/screenshot-2020-01-14-pm-9.53.05.png)

직교 투영에 비해 앞쪽에 보이는 면이 더 길어 보인다. 피라미드로 관찰하기 어렵다면 원통형으로 바꿔 보자. 팝업 메뉴에서 Cylinder를 선택하면 도형이 바뀔 것이다.

 ![](/assets/img/wp-content/uploads/2019/04/screenshot-2020-01-14-pm-9.53.28.png)
...
  ![](/assets/img/wp-content/uploads/2019/04/screenshot-2020-01-14-pm-9.54.25.png)
...
`DoReshape`에서는 `Action`에 따라 뷰포트 영역을 지정하며 `Action`은 팝업 메뉴로 선택한다. 디폴트대로 그리면 파란색 배경에 빨간색 삼각형이 그려질 것이다. 클리핑 영역이 뷰포트를 가득 채운다.
 ...
 ![](/assets/img/wp-content/uploads/2019/04/screenshot-2020-01-14-pm-9.55.55.png)
...
  ![](/assets/img/wp-content/uploads/2019/04/screenshot-2020-01-14-pm-9.57.12.png)
...
  ![](/assets/img/wp-content/uploads/2019/04/screenshot-2020-01-14-pm-9.58.37.png) ![](/assets/img/wp-content/uploads/2019/04/-2020-01-14-pm-9.59.16-e1579006794678.png)

뷰포트 변환을 윈도우 크기에 종속적으로 지정하면 윈도우 크기 변화에 따라 장면이 찌그러지는 부작용이 있다. 다음은 윈도우를 옆으로 길게 늘인 모양이다

 ![](/assets/img/wp-content/uploads/2019/04/screenshot-2020-01-14-pm-10.00.25.png)
...
  ![](/assets/img/wp-content/uploads/2019/04/screenshot-2020-01-14-pm-10.01.00.png) ![](/assets/img/wp-content/uploads/2019/04/screenshot-2020-01-14-pm-10.01.23.png)
