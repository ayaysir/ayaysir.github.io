...
### 참고: `double` 등의 자료형에서 **소수점 이하가 0인 경우 표시하지 않게 하는 방법**

예를 들어 변수 값이 3이면 3.0이 아닌 3으로 표기하고, 3.14인 경우 정상적으로 3.14로 표기하게 하는 방법은 다음과 같습니다.
...
<img fetchpriority="high" decoding="async" src="https://media.giphy.com/media/JpGugQB6A4DllsKib8/giphy.gif" alt="Programming GIF - Find &amp; Share on GIPHY" width="334" height="196">