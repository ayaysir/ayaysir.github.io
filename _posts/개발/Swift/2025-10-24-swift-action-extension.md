...
“Action Extension으로 사진을 내 앱에 넘기는 방법”은 Share Extension과 비슷하지만, Action Extension은 ‘공유’가 아니라 원본 앱의 컨텍스트 안에서 바로 실행되는 확장(App Extension) 입니다.
...
### (1) Action Extension Target 생성
 ...
 3.	이름 예: ImageTranslatorActionExtension<br>![target 생성](/assets/img/DevLog/swift-action-extension/1%20target.jpg) 
  - `ActionType`
    - Present UI: 액션 확장에서 시트 등 보이는 UI를 표시합니다. 이번 포스트에서는 Present UI 의 경우만 다룹니다.
    - No Present UI: UI를 표시하지 않습니다.
 4.	“Activate ...” 선택<br>![Activate 창](/assets/img/DevLog/swift-action-extension/2%20activate.jpg)
...
![Property View](/assets/img/DevLog/swift-action-extension/3%20property%20view.jpg)
...
![App Group 설정](/assets/img/DevLog/swift-action-extension/4%20app%20group.jpg)
...
![ActionExtension 추가됨](/assets/img/DevLog/swift-action-extension/5%20example.jpg)
